...
<p align="center" style="font-size: 1.2rem; margin-top: -10px; margin-bottom: 20px;">
...
<p align="center" style="margin-top: -10px; margin-bottom: 30px;">
  ...
  <a href="#quote">Random Dev Quote</a> •
  <a href="#top-repo">Top Contributed Repo</a> •
...
## 🌟 Open to
- Collaborations on full-stack & ML projects  
- Mentorship opportunities & internships  
- Feedback on project architecture and code reviews

---

## 🧭 Personal Philosophy
> I build practical solutions, not just pretty UI. I love solving real problems with clean, scalable code.
